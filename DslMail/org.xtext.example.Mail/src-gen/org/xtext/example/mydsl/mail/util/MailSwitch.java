...
public class MailSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        AlefasoMailaka alefasoMailaka = (AlefasoMailaka)theEObject;
        T result = caseAlefasoMailaka(alefasoMailaka);
        if (result == null) result = caseModel(alefasoMailaka);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Alefaso Mailaka</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Alefaso Mailaka</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseAlefasoMailaka(AlefasoMailaka object)
  {
    return null;
  }
